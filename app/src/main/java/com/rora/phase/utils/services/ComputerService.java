...
public class ComputerService extends Service {
    ...
    private final ComputerService.ComputerManagerBinder binder = new ComputerService.ComputerManagerBinder();
    ...
    public void removeComputer(ComputerDetails computer) {
        if (pollingTuple.computer.uuid.equals(computer.uuid)) {
    ...
    private ComputerDetails tryPollIp(ComputerDetails details, String address) {
        ...
        try {
            NvHTTP http = new NvHTTP(address, idManager.getUniqueId(), details.serverCert, PlatformBinding.getCryptoProvider(ComputerService.this));
    ...
    private void populateExternalAddress(ComputerDetails details) {
        ...
        boolean activeNetworkIsVpn = NetHelper.isActiveNetworkVpn(ComputerService.this);
        ConnectivityManager connMgr = (ConnectivityManager) ComputerService.this.getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public class ComputerManagerBinder extends Binder {
        ...
        public boolean addComputerBlocking(ComputerDetails fakeDetails) {
            return ComputerService.this.addComputerBlocking(fakeDetails);
        }
        ...
        public void startPolling(ComputerManagerListener listener) {
            ...
            // Set the listener
            ComputerService.this.listener = listener;
        ...
        public void stopPolling() {
            ...
            ComputerService.this.onUnbind(null);
        }
